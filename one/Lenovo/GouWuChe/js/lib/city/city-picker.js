    ...
    CityPicker.prototype = {
        ...
        render: function() {
            var p = this.getPosition(),
                ...
                this.getWidthStyle(p.width) + 'padding-left:6px;' +'height:' +
                p.height + 'px;line-height:' + (p.height - 1) + 'px;">' +
                (placeholder ? '<span class="placeholder">' + placeholder + '</span>' : '') +
                '<span class="title"></span><div class="arrow"></div>' + '</span>',

                dropdown = '<div class="city-picker-dropdown" style="left:100px;top:100%;' +
                ...
                (this.includeDem('county') ? '<a data-count="county">街道</a>' : '') +
                '</div>' +
